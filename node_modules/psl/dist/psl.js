...
"apigee.io",
"on-aptible.com",
"user.model.ts.aseinet.ne.jp",
"gv.vc",
"d.gv.vc",
"user.model.ts.party.eus",
"pimienta.org",
"poivron.org",
"potager.org",
"sweetpepper.org",
...
/*! https://mths.be/punycode v1.4.1 by @mathias */
	...
	function decode(input) {
		...
		// the first basic code points to the outputField.
		...
		for (index = basic > 0 ? basic + 1 : 0; index < inputLength; /* no final expression */) {
			...
			// Insert `n` at position `i` of the outputField
			output.splice(i++, 0, n);
