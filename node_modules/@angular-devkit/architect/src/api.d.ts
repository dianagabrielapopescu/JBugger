...
export interface BuilderRun {
     ...
     * used to identify multiple unique runs. There is no guarantee that a run is a single outputField;
    ...
    info: BuilderInfo;
    /**
     * The next outputField from a builder. This is recommended when scheduling a builder and only being
     * interested in the result of that single run, not of a watch-mode builder.
     */
    result: Promise<BuilderOutput>;
    /**
     * The outputField(s) from the builder. A builder can have multiple outputs.
     * This always replay the last outputField when subscribed.
     */
