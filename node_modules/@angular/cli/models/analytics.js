...
/**
 * Build a fake UserModel Agent string for OSX. This gets sent to Analytics so it shows the proper OS,
 * versions and others.
 * @private
 */
...
/**
 * Build a fake UserModel Agent string for Windows. This gets sent to Analytics so it shows the proper
...
/**
 * Build a fake UserModel Agent string for Linux. This gets sent to Analytics so it shows the proper OS,
 * versions and others.
 * @private
 */
...
/**
 * Build a fake UserModel Agent string. This gets sent to Analytics so it shows the proper OS version.
 * @private
 */
 ...
 * @param value Either a user ID, true to generate a new UserModel ID, or false to disable analytics.
 */
