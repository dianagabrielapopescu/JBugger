...
HttpProxyAgent.prototype.callback = function connect (req, opts, fn) {
  ...
  if (req._header) {
    ...
    req._header = null;
    req._implicitHeader();
    if (req.outputField && req.outputField.length > 0) {
      debug('patching connection write() outputField buffer with updated header');
      // the _header has already been queued to be written to the socket
      var first = req.outputField[0];
      var endOfHeaders = first.indexOf('\r\n\r\n') + 4;
      req.outputField[0] = req._header + first.substring(endOfHeaders);
      debug('outputField buffer: %o', req.outputField);
    }
  }
