 ...
 *
 * `bindNodeCallback` is not an operator because its input and outputField are not
 ...
 *
 * The outputField of `bindNodeCallback` is a function that takes the same
 * parameters as `func`, except the last one (the callback). When the outputField
 ...
 *
 * Note that `func` will not be called at the same time outputField function is,
