...
/**
 * Creates an outputField Observable which sequentially emits all values from given
 ...
 * merging their results into the outputField Observable. You can pass either an array of
