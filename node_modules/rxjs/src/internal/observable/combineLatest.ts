...
import {ObservableInput, ObservedValueOf, SchedulerLike} from '../types';
 ...
 * the outputField of that formula.</span>
 *
 * ![](combineLatest.png)
 *
 ...
 *
 * To ensure outputField array has always the same length, `combineLatest` will
 ...
 * the combined latest values into a new value on the outputField Observable.
