 ...
 * times in a serialized fashion on the outputField Observable.
 *
 ...
 * single Observable, which is the outputField Observable. Each new `innerObservable`
 * instance emitted on the outputField Observable is concatenated with the previous
