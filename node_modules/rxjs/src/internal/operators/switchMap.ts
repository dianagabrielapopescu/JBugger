...
/**
 * Projects each source value to an Observable which is merged in the outputField
 ...
 * inner Observables, the outputField Observable begins emitting the items emitted by
